...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.uf9twha.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    const workCollection = client.db("portfolio").collection("works");
    const showcase = client.db("portfolio").collection("Showcase")
